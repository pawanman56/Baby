...
<title>Add Toys - BabyCare CMS</title>
...
<div class="content">
    ...
    <div class="table">
		<h1 style="margin:0px; padding:0px; padding-top:5px; padding-left:20px;">Add New Toy</h1>
    	<section>
    
			<form method="post" action="toys_add_action.php" name="toy_add" id="toy_add" style="float:left; margin:0px 20px;" enctype="multipart/form-data">
				<table>
					<tr>

...
$id = $_GET['id'];
$q = "SELECT * FROM `tbl_recipe` WHERE `ID` = '$id'";
...
<title>Edit Recipe - BabyCare CMS</title>
...
<div class="content">
    ...
    <div class="table">
		<h1 style="margin:0px; padding:0px; padding-top:5px; padding-left:20px;">Update Recipe</h1>
    	<section>
    	
			<form method="post" action="recipe_edit_action.php" name="recipe_edit" id="recipe_edit" style="float:left; margin:0px 20px;">

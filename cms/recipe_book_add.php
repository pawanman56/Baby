...
<title>Add Recipe Book- BabyCare CMS</title>
...
<div class="content">
    ...
    <div class="table">
		<h1 style="margin:0px; padding:0px; padding-top:5px; padding-left:20px;">Add New Recipe Book</h1>
    	<section>
    
			<form method="post" action="recipe_book_add_action.php" name="recipe_book_add" id="recipe_book_add" style="float:left; margin:0px 20px;" enctype="multipart/form-data">
				<table>
					<tr>
